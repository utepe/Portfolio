      ...
      >
        ...
        <Grid item xs={4}>
          ...
          <Typography variant="body1" sx={{ textAlign: "left" }}>
            ...
            To do this I have worked in soft robotics, embedded systems and have aided in developing non-conventional Hardware-in-the-Loop environment for thermal systems. I have recieved a B.A.S.c in Electrical and Computer Engineering from the University of Windsor.
